...
public class BookStoreProfilePageSteps {
    ...
    public void verifyBooks() {
        ...
        //int expectedSize = bookList.size();
        //int actualSize = bookStoreProfilePage.bookRows.size();
        //Assert.assertEquals("The number of book in front end and back end do not match", expectedSize, actualSize);
        //bookStoreProfilePage.log.new Success("The number of book in front end and back end matches");
        ...
        for (BookModel book: bookList) {
            ...
            bookStoreProfilePage.log.new Success("Isbns matches for book named " + book.getTitle());
            ...
            bookStoreProfilePage.log.new Success("Titles matches for book named " + book.getTitle());
            ...
            bookStoreProfilePage.log.new Success("Sub Titles matches for book named " + book.getTitle());
            ...
            bookStoreProfilePage.log.new Success("Authors matches for book named " + book.getTitle());
            ...
            bookStoreProfilePage.log.new Success("Publishers matches for book named " + book.getTitle());
            ...
            bookStoreProfilePage.log.new Success("Pages matches for book named " + book.getTitle());
            ...
            bookStoreProfilePage.log.new Success("Websites matches for book named " + book.getTitle() );
